...
7. After they respond, ask why they chose that option and why their choices are similar to or different from what they chose previously. If they flipped (chose $10,000 in the prior choice [step 4] but the $7,500 in the current one [step 6]) then explicitly ask them why they flipped. Make sure to check for this flip.\n
